...
# GPU-specific memory configs (for different GPUs)
# Use: MEMORY_CONFIGS_BY_GPU["titan_rtx"]["medgemma-4b"]
MEMORY_CONFIGS_BY_GPU = {
    "a6000": MEMORY_CONFIGS,  # Default: RTX A6000 (48GB)
    "titan_rtx": {
        "medgemma-4b": {
            "use_gradient_checkpointing": True,
            "train_embeddings": False,  # Disable for 24GB GPU
            "peak_memory_gb": 18.0,
            "remaining_gb": 5.5,
            "batch": 1,           # Smaller batch
            "grad_accum": 32,     # Larger accumulation
        },
        "medgemma-27b": {
            "use_gradient_checkpointing": True,
            "train_embeddings": False,
            "peak_memory_gb": 22.0,     # Too large for TITAN RTX
            "remaining_gb": 1.5,
            "note": "May not fit on TITAN RTX 24GB",
        }
    }
}
